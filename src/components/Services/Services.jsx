      ...
      <div className="cards">
        ...
        >
          <Card
            emoji={HeartEmoji}
            heading={"Design"}
            detail={"Microsoft Office-2016, Sketch Draw, Photoshop 2020, Netwoking "}
          />
        </motion.div>
        {/* second card */}
        <motion.div
        ...
        >
          <Card
            emoji={Glasses}
            heading={"Developer"}
            detail={"Html, CSS, JavaScript, React js,React Native, Python , Java"}
          />
        </motion.div>
        {/* 3rd */}
        <motion.div
        ...
        >
          <Card
            ...
            detail={
              "MongoDB , RDBMS , PC Assemble , Machine Learning , Software and hardware Setup"
            }
